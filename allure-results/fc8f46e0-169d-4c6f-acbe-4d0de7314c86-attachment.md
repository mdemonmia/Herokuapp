...
Call log:
  - waiting for locator('editContactBtn') to be visible
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - table [ref=e10]:
      ...
      - rowgroup
      - row "Dilruba Akter 2000-05-28 dilrubaakterdiparpicse0008@gmail.com 01738438619 Uttara,Dhaka Sector-11 Dhaka Uttara 1206 Bangladesh" [ref=e20]:
        - cell "Dilruba Akter" [ref=e21]
        - cell "2000-05-28" [ref=e22]
        - cell "dilrubaakterdiparpicse0008@gmail.com" [ref=e23]
...
> 60 |      await page.waitForSelector('editContactBtn')
     |                 ^ TimeoutError: page.waitForSelector: Timeout 60000ms exceeded.
