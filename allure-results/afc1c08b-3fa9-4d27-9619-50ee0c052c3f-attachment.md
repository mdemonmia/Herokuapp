...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - table [ref=e10]:
      ...
      - rowgroup
      - row "dilruba akter 2000-05-28 dilrubaakterdiparpicse03@gmail.com 01738438619 Uttara,Dhaka Sector-11 Dhaka Uttara 1206 Bangladesh" [ref=e20]:
        - cell "dilruba akter" [ref=e21]
        - cell "2000-05-28" [ref=e22]
        - cell "dilrubaakterdiparpicse03@gmail.com" [ref=e23]
...
```ts
  ...
  56 |      
> 57 |      await page.waitForURL(/contacts\//);
     |                 ^ Error: page.waitForURL: Test timeout of 60000ms exceeded.
  58 | 
  59 | 
